...
namespace DiplomadoMVC
{
    public partial class Startup
    {
        ...
        public void ConfigureRoles()
        {
            ...
            //Crea el rol y usuario principal de Administrador si no existe
            if (!roleManager.RoleExists("Administrador"))
            {
                ...
                //Crea el usuario
                var admin = new ApplicationUser { UserName = "admin@diplomado.com", Email = "admin@diplomado.com" };
                var createdUser = userManager.Create(admin, "123456");

                //Si todo sale como esperamos agrega el rol al administrador
                if (createdUser.Succeeded)
                    userManager.AddToRole(admin.Id, role.Name);
            }

            // Crea rol de Usuario si no existe
